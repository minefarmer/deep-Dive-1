...
with open(module_rel_file_path, 'r') as code_file:
    source_code = code_file.read()  # Traceback (most recent call last):
#   File "c:\Users\pgold\MatsHub\deep-Dive-1\class_notes\modules_packages_namespaces\example3a\module1_source.py", line 24, in <module>
#     with open(module_rel_file_path, 'r') as code_file:
