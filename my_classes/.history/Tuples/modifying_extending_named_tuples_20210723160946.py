...
djia = stock('DJIA', 2021, 7, 26, 26313, 26458, 26260, 26393)

How about modifying both the day and the high values?

new_values - djia[:3] + (26, ) + djia[4:5] + (26459, ) + djia[6:]   # this is very unreadable and extremely error prone!
...
It will copy the named tuple into a new one, replacing any values from keyword argument
