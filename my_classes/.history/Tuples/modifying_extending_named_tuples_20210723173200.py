...
We can also easily use an exisiting Stock instance to create a new StockExit instance with the same common values, adding in our new previous_close value:
