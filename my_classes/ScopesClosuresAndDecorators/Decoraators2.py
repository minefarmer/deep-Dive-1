...
The outer function is not itseld a decorator, instead it returns a decorator when called

and any arguments passed to outer can be referenced (as free variabled) inside my decorator

We call this outer function a decoratory function
...
def timed(reps):        <==  this wad outer

    def dec(fn):    <----this was timed

TODO: decorators Part 2 code
"""
