...
from common.validators.numeric import is_integar, is_numeric
import common.validators_as_validators

common.validators.json.is_json('{}')
common.validators.date.is_date('2018-01-01')
validators.numeric(chr[, default]).is_numeric(10)
validators.is_interger("100")
