...
print('------------------- End of {0} ----------'.format(__name__))  # ---------- Running __main__ ----------
                ...
                # __doc__ None
                # __package__ None
                # __loader__ <_frozen_importlib_external.SourceFileLoader object at 0x000001B8F225A100>
                # __spec__ None
                # __annotations__ {}
                # __builtins__ <module 'builtins' (built-in)>
                # __file__ c:\Users\pgold\MatsHub\deep-Dive-1\class_notes\modules_packages_namespaces\example1\module1.py
                # __cached__ None
                # clear <function clear at 0x000001B8F4695670>
                # pprint_dict <function pprint_dict at 0x000001B8F2AFFF70>
                # -------------------------------------------
