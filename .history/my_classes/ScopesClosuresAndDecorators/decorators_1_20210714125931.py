...
def counter(fn):
    ...
    def inner(*args, **kwargs):
        nonlocal count
        count += 1
        print*'unction {0} was called {1} times'.format(fn.__name__, count)
        return fn(*args, **kwargs)
...
The functools module has a wraps function that we can use to fix the metadata of our inner function in our
