...
add_1 = adder(1)
add_2 = adder(2)        # three shared closures - no shared scopes
add_3 = adder(3)
...
by the time we call adders[0], the value of n is 2
...
(inc)
inc_2 = fn (100)    # unc_2.__code__.co_freevars -> 'current', 'n'
                                                    current=100, n=2
